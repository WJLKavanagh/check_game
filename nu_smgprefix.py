...
def run(characters, model, multiple):    #USAGE: python prefix.py A B C D model_type
    ...
    if model == "smg":
            ...
            for i in range(2):
                if chars[i] =="A":
                    print "[team_1_turn_" + ["A","B"][i] + "_opp],",
                else:
                    print "[team_1_turn_" + ["A","B"][i] + "_C] , [team_1_turn_" + ["A","B"][i] + "_D],",

            print "[team_1_turn_skip]\nendplayer"


            print "\n\nplayer p2\n\t",
            for i in range(2):
                if chars[i+2] =="A":
                    print "[team_2_turn_" + ["C","D"][i] + "_opp],",
                else:
                    print "[team_2_turn_" + ["C","D"][i] + "_A], [team_2_turn_" + ["C","D"][i] + "_B],",
            print "[team_2_turn_skip]\nendplayer\n"
